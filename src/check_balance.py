"""
Check your Polymarket USDC balance and wallet setup.

Run with: python -m src.check_balance
"""
...
def main():
    ...
    print("=" * 70)
    print("BTC 15M ARB BOT - BALANCE CHECK")
    print("=" * 70)
    print(f"Host: {host}")
        ...
        try:
            ...
            if isinstance(result, dict):
                ...
                try:
                    ...
                    balance_onchain = usdc_contract.functions.balanceOf(
                        wallet_address
                    ).call()
